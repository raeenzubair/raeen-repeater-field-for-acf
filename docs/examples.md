...
fetch( '/wp-json/acf-repeater/v1/repeater/field_abc123?post_id=123' )
    .then( response => response.json() )
    .then( data => console.log( data ) );

// Add a new row
fetch( '/wp-json/acf-repeater/v1/repeater/field_abc123/rows', {
    method: 'POST',
    headers: {
...
// Update a row
fetch( '/wp-json/acf-repeater/v1/repeater/field_abc123/rows/0', {
    method: 'PUT',
    headers: {
        'Content-Type': 'application/json',
        'X-WP-Nonce': 'your-nonce-here'
...
// Delete a row
fetch( '/wp-json/acf-repeater/v1/repeater/field_abc123/rows/0?post_id=123', {
    method: 'DELETE',
    headers: {
        'X-WP-Nonce': 'your-nonce-here'
    }
