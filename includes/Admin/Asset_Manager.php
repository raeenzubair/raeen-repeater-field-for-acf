...
class Asset_Manager {
	...
	private function localize_admin_script(): void {
		...
		$data = array(
			...
			'i18n'       => array(
				'add_row'         => __( 'Add Row', 'acf-repeater' ),
				'delete_row'      => __( 'Delete Row', 'acf-repeater' ),
				'duplicate_row'   => __( 'Duplicate Row', 'acf-repeater' ),
				'collapse_row'    => __( 'Collapse Row', 'acf-repeater' ),
				...
				'no_rows'         => __( 'No rows added yet. Click "Add Row" to get started.', 'acf-repeater' ),
				'row_collapsed'   => __( 'Row collapsed', 'acf-repeater' ),
				'row_expanded'    => __( 'Row expanded', 'acf-repeater' ),
				'drag_to_reorder' => __( 'Drag to reorder', 'acf-repeater' ),
			),
